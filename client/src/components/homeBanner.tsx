    ...
    <div className="bg-gradient-to-br from-green-50 to-indigo-100 min-h-[600px] flex items-center justify-center">
      <div className="text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button 
            onClick={() => router.push('/pages/createCampaign')}
            className="px-8 py-4 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-all duration-300"
          >
            Start a Fundraiser
          </button>
        </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-md mx-auto">
            ...
            <button 
              ...
              className="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors"
            >
              Search
            </button>
          </div>
